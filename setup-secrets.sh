...
echo "   npm run deploy"
echo ""
echo "3. Configure RECORDINGS_PUBLIC_BASE_URL in wrangler.jsonc (or .dev.vars) so uploaded recordings resolve in Notion."
echo "   Use https://pub-358b252982f749d78ef2628cb2b3450b.r2.dev and set SELF_PHONE_NUMBERS to [\"+13365195544\"]."
